      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <img src={item.imgSrc} alt={item.title} className="w-20 h-20 mx-auto mb-4 object-contain" />
